...
@tool
class_name ContinuumTickSchedule extends _ModuleTableType
...
static func create(p_scheduled_id: int, p_scheduled_at: int) -> ContinuumTickSchedule:
	var result: ContinuumTickSchedule = ContinuumTickSchedule.new()
